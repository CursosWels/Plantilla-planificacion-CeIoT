...
\fechaFINALTrabajo{30 de mayo de 2026}	%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en implementar una mejora en el sistema actual que posee en el Radio Observatorio de Jicamarca. El trabajo tendrá un presupuesto preliminar estimado de 658 horas y un costo estimado de \$3506,1 doláres americanos, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación en el mes de mayo del 2026.
